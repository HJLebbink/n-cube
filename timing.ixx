...
namespace tools::timing {
	...
	export inline void reset_and_start_timer() {
	...
	export inline double get_elapsed_mcycles() {
	...
	export inline double get_elapsed_kcycles()
	{
		priv::timing_end = rdtsc();
	...
	export inline unsigned long long get_elapsed_cycles()
	{
		priv::timing_end = rdtsc();
		return (priv::timing_end - priv::timing_start);
	}

	export inline std::string elapsed_cycles_str(const unsigned long long start, const unsigned long long end)
	{
	...
	export inline std::string elapsed_time_str(const std::chrono::system_clock::time_point start, const std::chrono::system_clock::time_point end)
	{
		std::ostringstream os;
		const auto diff = end - start;
